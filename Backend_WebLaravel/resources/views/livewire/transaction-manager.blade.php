<div class="space-y-6 relative">
    ...
    >
        ...
        <div class="flex-1 w-full md:w-auto">
            ...
            <select wire:model.live="type" class="w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm focus:border-brand-500 focus:ring-brand-500">
